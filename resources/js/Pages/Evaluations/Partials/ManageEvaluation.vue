...
Inertia.on('success', (event) => {
    ...
    if (pageType === 'Evaluations/Partials/ManageEvaluation' && newProps) {
        editedEvaluation.value = newProps.kita;
    }
});
...
//     id: editedEvaluation.value.id,
//     name: editedEvaluation.value.name,
//     zip_code: editedEvaluation.value.zip_code,
// });
//
...
//     kitas: [editedEvaluation.value.id]
// });
//
...
<template>
    <Head title="Verwalte Evaluation"/>

    <AuthenticatedLayout :errors="errors">
        <template #header>
            <h2 class="tw-font-semibold tw-text-xl tw-text-gray-800 tw-leading-tight">Verwalte Evaluation</h2>
        </template>
