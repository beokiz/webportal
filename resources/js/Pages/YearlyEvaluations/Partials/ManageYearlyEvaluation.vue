...
// const rawSurveyStart = ref(prepareDate(props.yearlyEvaluation.survey_start_date));
// const rawSurvayEnd = ref(prepareDate(props.yearlyEvaluation.survey_end_date));
// const surveyStart = ref(new Date(props.yearlyEvaluation.survey_start_date).toString());
// const survayEnd = ref(new Date(props.yearlyEvaluation.survey_end_date).toString());
...
//     age: editedYearlyEvaluation.value.age,
...
<template>
    ...
    <AuthenticatedLayout :errors="errors">
        <template #header>
            <h2 class="tw-font-semibold tw-text-xl tw-text-gray-800 tw-leading-tight">Jährliche Jährliche Rückmeldung {{ yearlyEvaluation.year }}</h2>
        </template>
