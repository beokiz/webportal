...
<template>
    ...
    <AuthenticatedLayout :errors="errors">
        ...
        <div v-if="$page.props.auth.user.is_super_admin || $page.props.auth.user.is_admin" class="tw-table-block tw-max-w-full tw-mx-auto tw-py-6 tw-px-4 sm:tw-px-6 lg:tw-px-8">
        ...
        <div class="tw-table-block tw-max-w-full tw-mx-auto tw-py-6 tw-px-4 sm:tw-px-6 lg:tw-px-8">
            <v-row v-if="$page.props.auth.user.is_super_admin || $page.props.auth.user.is_admin" class="flex justify-end mb-4">
                <v-hover v-slot:default="{ isHovering, props }">
