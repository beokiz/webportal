...
const modifiedItems = computed(() => {
    return props.operator.users.map(item => {
...
const deleteUserFromOperator = async () => {
    ...
    deleteForm.post(route('operators.disconnect_user', {id: props.operator.id}), formOptions);
};
                    ...
                    <v-card height="30vh">
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    <v-col cols="12">
                                        <p>Sind Sie sicher, dass Sie den Benutzer {{deletingItemName}} aus Träger Liste löschen möchten? (Der Benutzer wird vom aktuellen Träger getrennt)</p>
                                    </v-col>
                                </v-row>
                            </v-container>
                        </v-card-text>
