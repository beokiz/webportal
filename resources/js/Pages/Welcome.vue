    ...
    >
        ...
        <div class="tw-max-w-7xl tw-mx-auto tw-p-6 lg:tw-p-8">
            ...
            <div class="tw-mt-16">
                <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6 lg:tw-gap-8">
                    ...
                    >
                        <div>
                            <div
                                class="tw-h-16 tw-w-16 tw-bg-red-50 dark:tw-bg-red-800/20 tw-flex tw-items-center tw-justify-center tw-rounded-full"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                    ...
                    >
                        <div>
                            <div
                                class="tw-h-16 tw-w-16 tw-bg-red-50 tw-dark:bg-red-800/20 tw-flex tw-items-center tw-justify-center tw-rounded-full"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
            ...
            <div class="tw-flex tw-justify-center tw-mt-16 tw-px-6 sm:tw-items-center sm:tw-justify-between">
                ...
                <div class="tw-ml-4 tw-text-center tw-text-sm tw-text-gray-500 dark:tw-text-gray-400 sm:tw-text-right tw-sm:ml-0">
