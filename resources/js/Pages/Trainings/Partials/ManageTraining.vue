                                    ...
                                    <tr :data-id="item.id" :data-order="item.order">
                                        ...
                                        <td class="text-center">
                                              ...
                                              <v-tooltip location="top">
                                                  <template v-slot:activator="{ props }">
                                                      <Link :href="`${route('kitas.show', { id: item.id })}?from=trainings.show;training;${editedTraining.id}`">
                    ...
                    <v-dialog v-model="removeKitaFromTrainingDialog" width="20vw">
                        <v-card height="30vh">
                            ...
                            <v-card-actions>
                                ...
                                <v-hover v-slot:default="{ isHovering, props }">
                                    <v-btn-primary @click="removeKitaFromTraining" v-bind="props" :color="isHovering ? 'accent' : 'primary'">Einreichen</v-btn-primary>
                                </v-hover>
                            </v-card-actions>
                        </v-card>
                    </v-dialog>
