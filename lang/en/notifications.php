...
return [
    ...
    */
    ...
    'kita_certificate' => [
        ...
        'fourth_line' => "Furthermore, we would like to remind you of the BeoKiz Forum.",
        'fifth_line'  => "The BeoKiz Forum takes place on the last Wednesday of every month, except in December, where it is held on the last Wednesday before Christmas.",
        'sixth_line'  => "This forum is intended for all trained professionals and managers from Berlin daycare centers or child daycare. A colleague from the KiTeAro Institute will be present to moderate and answer questions. With this format, we especially want to support the collegial exchange between the participants.",
        'seventh_line' => "No registration is necessary.",
        'zoom_title' => "**Zoom-Link for the BeoKiz Forum for trained KiTas:**",
        'zoom_link' => "https://link.kitearo.de/BeoKizForum",
        'zoom_meeting_id' => "Meeting ID: 867 1267 9075",
        'zoom_password' => "Password: 236794",
