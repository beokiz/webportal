...
return [
    ...
    */
    ...
    'common' => [
        'create_success' => "Erfolg! Der Artikel wurde erfolgreich erstellt.",
        'create_error'   => "Fehler! Beim Erstellen des Artikels ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.",
        'update_success' => "Erfolg! Der Artikel wurde erfolgreich aktualisiert.",
        ...
        'delete_success' => "Erfolg! Der Artikel wurde erfolgreich gelöscht.",
    ...
    */
    ...
    'user' => [
        'create_success'  => "Erfolg! Der Benutzer wurde erfolgreich erstellt.",
        'create_error'    => "Fehler! Beim Erstellen des Benutzers ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.",
        'update_success'  => "Erfolg! Der Benutzer wurde erfolgreich aktualisiert.",
        ...
        'delete_success'  => "Erfolg! Der Benutzer wurde erfolgreich gelöscht.",
        ...
        'restore_success' => "Erfolg! Der Benutzer wurde erfolgreich wiederhergestellt.",
